...
export function SiteNav() {
  ...
  return (
    <header className="relative flex items-center justify-between gap-6 py-6">
      ...
      <nav className="hidden items-center gap-6 lg:flex">
        {nav.links.map((l) => (
          <a key={l.label} href={l.href} className="t-body hover:opacity-60 transition-opacity">
            {l.label}
          </a>
        ))}
      </nav>
      ...
      <div className="hidden items-center gap-4 lg:flex">
        ...
        <a href={nav.lang.href} className="t-body hover:opacity-60 transition-opacity">
          {nav.lang.label}
        </a>
      </div>
